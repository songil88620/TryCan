      ...
      <div className="order-confirm-wrapper">
        ...
        <div className="order-desc-area">
              ...
              props.usertype === 'dispensary' ?
                <>
                  ...
                  <div className="row-array space-between">
                    ...
                    <h3>-${userId == "0SDcLRbvhXd9WBLZJaGeTSViHFr1" ? (props.totalPrice * 0.225).toFixed(2) : (props.totalPrice * 0.3).toFixed(2)}</h3>
                  </div>
                </>
                : props.paid ?
                  <>
          ...
          <div className="row-array space-between mt90 full-width mb90">
            ...
            {
              props.usertype === 'dispensary' ?
                <h1 className="payout-price">${userId == "0SDcLRbvhXd9WBLZJaGeTSViHFr1" ? (props.totalPrice * 0.775).toFixed(2) : (props.totalPrice * 0.7).toFixed(2)}</h1>
                :
                <h1 className="payout-price">${userId == "0SDcLRbvhXd9WBLZJaGeTSViHFr1" ? (props.totalPrice * 0.775).toFixed(2) : (props.totalPrice * 0.7).toFixed(2)}</h1>
            }
          </div>
