...
import WebViewOrderConfirm from './WebViewOrderConfirm'
...
function WebViewOrderConfirmWrapper(props) {
  ...
  return (
    <div className="webview-order-cont-wrapper">
      ...
      {loading ?
        ...
        <div>
          <div className="order-cont" id="orderHistory">
            ...
            {orderData !== '' && orderData !== null && orderData.length !== 0 ? orderData.map(el => (<WebViewOrderConfirm key={el.oderId} {...el} qty2={1} usertype={props.usertype} userData={userData} />)) :
              <div className="mt90">
            ...
            {orderData !== '' && completedData !== null && completedData.length !== 0 ? completedData.map(el => (<WebViewOrderConfirm key={el.oderId} {...el} price1='$12.55' paid usertype={props.usertype} userData={userData} />))
              : <div className="mt90">
...
export default WebViewOrderConfirmWrapper
